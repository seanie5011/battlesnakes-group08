...
class Food:
    ...
    def __init__(self, map_size, food_spawn_locations=[], food_spawn_chance=0.15):
    ...
    def spawn_food(self, snake_map):
        ...
        '''
        # if we have any locations to spawn food, do so (and them remove that)
